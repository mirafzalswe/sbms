...
- Сначала проанализируй весь проект (структура, логика, зависимости)
- Изучи все API (request/response, ошибки, edge cases)
- НИЧЕГО не ломай и не меняй без необходимости
- Любые изменения должны быть безопасными и не влиять на другие части
